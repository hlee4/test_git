...
#=== (1) Get Data from WEB ===#
## (1-1) Define Data-Download Function
def download_DF_stock(company_name, company_code, START, END):
...
## (1-3) Download Data from WEB and Save Data to file
#DF_stock = download_DF_stock(company_name, company_code, START, END)
#print(DF_stock.head(5))


#=== (2) Load Data from file ===#
## (2-1) Define Data-Load Function
def load_DF_stock(file_name):
...
## (3-3) Hurst Exponent TEST  :: 기하브라운운동(GBM) 보다 천천히 값이 퍼져나가는지 확인(정상과정은 평균과 표준편차가 일정해서 랜덤워크보다 천천히 확산됨)
