...
##    candlestick_ohlc(ax=ax1, quotes=zip(df.index.levels[0], df['open'],df['high'],df['low'],df['close']))
    candlestick_ohlc(ax=ax1, quotes=zip(df.index.levels[1],df['open'],df['high'],df['low'],df['close']))
